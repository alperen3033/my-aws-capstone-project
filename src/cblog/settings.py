...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.csp3po8jqhww.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesalperenblog' # please enter your s3 bucket name
